...
public class buyer {
	...
	public String toString() {
		String out = "\n===============장바구니================\n"+ 
				"회원번호 :"+member_num+"  회원명: "+member_num+"\n"+
						"장바구니 목록 \n";
		for(int i=0; i<basket.length;i++) {
			out += (i+1)+". "+basket[i]+"\n";
		}
		out += "총 결재 금액: "+ total_price();
		return out;
	}
	...
	void payment() {	// 장바구니의 물건 전부 구입, 비용지불, basket배열 비우기
		expend = Integer.parseInt(total_price().replaceAll("[^0-9]",""));
		
		System.out.println( "결재 금액은 "+total_price()+" 입니다.");
