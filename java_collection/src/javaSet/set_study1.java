...
//		System.out.println(set);
		...
		// collection 전용 interface   Iterator(일회용이다)
		Iterator<String> it = 안경쓴사람.iterator();
		while(it.hasNext()) {	// 두개의 그룹중 하나를 순회하면서 다른하나로
			String name = it.next();
		...
		List<String> names = new ArrayList<String>(안경과슈);		//HashSet 값을 ArrayList 로
